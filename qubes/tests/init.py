...
class TC_10_property(qubes.tests.QubesTestCase):
    ...
    def test_002_eq(self):
        self.assertEqual(
            qubes.property("testprop2"), qubes.property("testprop2")
        )
    ...
    def test_010_set(self):
        ...
        self.assertEventFired(
            self.holder,
            "property-pre-set:testprop1",
            kwargs={"name": "testprop1", "newvalue": "testvalue"},
        )
        self.assertEventFired(
            self.holder,
            "property-set:testprop1",
            kwargs={"name": "testprop1", "newvalue": "testvalue"},
        )
    ...
    def test_022_get_default(self):
        ...
        self.assertEqual(
            type(holder).testprop1.get_default(holder), "defaultvalue"
        )

    def test_023_get_default_func(self):
        class MyTestHolder(qubes.tests.TestEmitter, qubes.PropertyHolder):
            testprop1 = qubes.property(
                "testprop1", default=(lambda self: "defaultvalue")
            )
    ...
    def test_080_delete(self):
        ...
        self.assertEventFired(
            self.holder,
            "property-pre-del:testprop1",
            kwargs={"name": "testprop1", "oldvalue": "testvalue"},
        )
        self.assertEventFired(
            self.holder,
            "property-pre-reset:testprop1",
            kwargs={"name": "testprop1", "oldvalue": "testvalue"},
        )
        self.assertEventFired(
            self.holder,
            "property-del:testprop1",
            kwargs={"name": "testprop1", "oldvalue": "testvalue"},
        )
        self.assertEventFired(
            self.holder,
            "property-reset:testprop1",
            kwargs={"name": "testprop1", "oldvalue": "testvalue"},
        )
...
<qubes version="3">
    ...
    def test_000_property_list(self):
        self.assertListEqual(
            [p.__name__ for p in self.holder.property_list()],
    ...
    def test_001_property_get_def(self):
        ...
        self.assertIs(
            self.holder.property_get_def(TestHolder.testprop1),
    ...
    def test_006_xml_properties(self):
        ...
        expected_prop2 = lxml.etree.Element(
            "property", name="testprop2", ref="testref2"
        )
    ...
    def test_007_property_get_default(self):
        self.assertEqual(
            self.holder.property_get_default("testprop3"), "testdefault"
        )
        with self.assertRaises(AttributeError):
