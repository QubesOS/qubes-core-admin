...
class QubesTypeError(ProtocolError, TypeError):
    """Cannot set some value, because it has incorrect type."""
...
class QubesTagNotFoundError(QubesException, ProtocolError, KeyError):
...
class QubesLabelNotFoundError(QubesException, ProtocolError, KeyError):
...
class QubesVolumeCopyInUseError(ProtocolError, Exception):
...
class QubesLabelInUseError(ProtocolError, Exception):
    """Cannot remove label as it is still in use."""
