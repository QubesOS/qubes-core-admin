...
man_pages = [
    (
        "manpages/qubesd-query",
        "qubesd-query",
        "Low-level qubesd interrogation tool",
        _man_pages_author,
        1,
    ),
]
...
if os.path.exists("sandbox.rst"):
    man_pages.append(
        ("sandbox", "sandbox", "Sandbox manpage", "Sandbox Author", 1)
    )
...
intersphinx_mapping = {
    ...
    "core-qrexec": (
        "https://doc.qubes-os.org/projects/core-qrexec/en/stable/",
        None,
    ),
}
